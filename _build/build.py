  ...
  <div class="wrap">
    <div class="grid grid-2" style="gap:56px;align-items:start">
      <div class="prose">
        ...
        <p>본 연구실에는 아래 네 개 대학원 프로그램 중 어느 경로로도 진학할 수 있습니다. 어느 쪽으로 오시든 지도교수와
        연구 내용은 동일하며, 지원하는 학과·대학원과 교과과정, 전형 일정이 다릅니다. 어떤 경로가 맞을지 판단이 어려우면
        지원 전에 먼저 문의해 주세요.</p>
        <p class="prog-en">Students join the lab through any of four POSTECH graduate programmes. The advisor and the
        research are the same in each; what differs is the department or graduate school you apply to, its curriculum
        and its admission schedule. Ask us before applying if you are unsure which route fits you.</p>
        <ul class="prog-list">
          <li>
